...
export const config = Object.freeze({
  ...
  smsHealthUrl: process.env.SMS_HEALTH_URL || '',
  smsHealthIntervalMs: integer('PPO_SMS_HEALTH_INTERVAL_MS', 5 * 60_000, 30_000),
  smsHealthTimeoutMs: integer('PPO_SMS_HEALTH_TIMEOUT_MS', 5_000, 1_000),
